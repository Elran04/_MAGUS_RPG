...
class EquipmentRepository:
    ...
    def __init__(self):
        self._weapons_cache: Optional[list[dict]] = None
        self._armor_cache: Optional[list[dict]] = None
    ...
    def find_weapon_by_id(self, weapon_id: str) -> Optional[dict]:
        """
    ...
    def find_armor_by_id(self, armor_id: str) -> Optional[dict]:
