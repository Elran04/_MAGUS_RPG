...
class CriticalContext:
    ...
    critical_threshold: Optional[int] = None  # If None, derive from skill
...
def is_critical_hit(attack_roll: int, weapon_skill_level: int, 
                    threshold_override: Optional[int] = None) -> bool:
    """
