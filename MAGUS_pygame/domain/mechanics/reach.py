...
def get_weapon_reach(weapon: Optional[Weapon]) -> int:
    """
...
def compute_reach_hexes(unit: Unit, weapon: Optional[Weapon] = None) -> set[tuple[int, int]]:
    """
...
def can_attack_target(attacker: Unit, target_position: Position, weapon: Optional[Weapon] = None) -> bool:
    """
...
def calculate_mandatory_ep_loss(weapon: Optional[Weapon], fp_damage_dealt: int) -> int:
    """
