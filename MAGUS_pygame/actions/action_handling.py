...
import pygame
from config import HEIGHT, UI_ACTIVE, UI_BORDER, UI_INACTIVE, UI_TEXT
...
def draw_action_ui(
    screen: pygame.Surface, ui_state: dict[str, object], action_mode: str, active_unit=None
):
...
def process_action_ui_click(
    mx: int, my: int, ui_state: dict[str, object], active_unit=None
) -> dict[str, any] | None:
    """
