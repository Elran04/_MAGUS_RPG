...
from config import WIDTH, HEIGHT, GRASS_BACKGROUND, get_character_sprite_path
from domain.value_objects import ScenarioConfig, UnitSetup
from infrastructure.rendering.hex_grid import hex_to_pixel, pixel_to_hex, get_grid_bounds
...
class DeploymentScreen:
    ...
    def __init__(self, screen_width: int, screen_height: int, config: ScenarioConfig, context: GameContext):
        ...
        # Load sprites
        self.unit_sprites: Dict[int, Optional[pygame.Surface]] = {}
    ...
    def _deploy_unit_at(self, q: int, r: int) -> None:
        ...
        logger.info(f"Deployed unit {self.current_unit_index} ({current_unit.character_file}) at ({q}, {r})")
    ...
    def _draw_grid_with_units(self, surface: pygame.Surface) -> None:
        ...
        Args:
            surface: Surface to draw on
        """
        from infrastructure.rendering.hex_grid import draw_hex_outline, HEX_COLOR_OUTLINE
