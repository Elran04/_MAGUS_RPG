...
class MapSelectionPhase(SelectionPhaseBase):
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        if self._cached_scenario_name != scenario_name:
            ...
            self._cached_scenario_data = self.context.scenario_service.get_scenario_preview_data(
                scenario_name
            )
        ...
        display_name = (
            self._cached_scenario_data.get("name") if self._cached_scenario_data else scenario_name
        )
