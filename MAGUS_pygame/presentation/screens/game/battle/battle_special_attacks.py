"""
Special attack registry and modes for battle screen.

Manages special attack configuration, entry conditions, and targeting.
Allows easy extension for new special attacks without modifying battle screen.
"""
...
class SpecialAttackRegistry:
    ...
    def __init__(self, battle_service, action_executor):
        ...
        # Build registry: attack_id -> (validate_fn, execute_fn)
        self._registry = {
            "charge": (
    ...
    def register(
        ...
        """Register a new special attack.

        Args:
            attack_id: Unique identifier for the attack
            validate_fn: Validation function(unit, target_pos) -> (is_valid, error_msg)
            execute_fn: Execution function(target_pos) -> dict
        """
    ...
    def validate_and_execute(
        ...
        """Validate and execute a special attack.
        ...
        Returns:
            True if executed successfully, False if validation failed
        """
