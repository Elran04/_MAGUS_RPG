...
|-------------|--------------|-------|
| `core/unit_manager.py` → Unit | `domain/entities/__init__.py` | Now uses value objects |
| `systems/combat_stats.py` | `domain/value_objects/__init__.py` | CombatStats value object |
| `systems/hex_grid.py` | `infrastructure/rendering/hex_grid.py` + `domain/value_objects/Position` | Split logic/data |
| `systems/damage_calculator.py` | TODO: `domain/mechanics/damage.py` | Not yet ported |
| `systems/reach.py` | TODO: `domain/mechanics/reach.py` | Not yet ported |
| `systems/weapon_wielding.py` | TODO: `domain/mechanics/weapon.py` | Not yet ported |
