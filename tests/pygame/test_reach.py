...
from domain.value_objects import Facing, Position, ResourcePool
...
class TestWeaponReach:
    ...
    def test_all_weapon_sizes(
        self, weapon_size_1, weapon_size_2, weapon_size_3, weapon_size_4, weapon_size_5
    ):
