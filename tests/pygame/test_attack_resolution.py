...
class TestDefenseCalculation:
    ...
    def test_with_dodge_skill(self, defender, basic_weapon):
        ...
        defender.weapon = basic_weapon
        defense = calculate_defense_values(defender, shield_ve=15, dodge_modifier=20)
    ...
    def test_with_conditions(self, defender):
        ...
        defense = calculate_defense_values(
            defender, condition_modifier=-10  # Wounded, stunned, etc.
        )
...
class TestAttackCalculation:
    ...
    def test_with_conditions(self, attacker, basic_weapon):
        ...
        all_te = calculate_attack_value(
            attacker, attack_roll=50, weapon=basic_weapon, condition_modifier=10  # Blessed, etc.
        )
...
class TestCriticalOverpowerCombination:
    ...
    def test_critical_and_overpower_both_active(
        ...
        monkeypatch.setattr(
            HitzoneResolver, "resolve", classmethod(lambda cls, rng=None: "mellvért")
        )
    ...
    def test_critical_overpower_ignores_armor(
        self, attacker, defender, basic_weapon, armor_set, monkeypatch
    ):
        ...
        assert (
            armor_set["helm"].get_sfé("sisak") == original_helm_sfe
        )  # Helm unchanged on chest hit
