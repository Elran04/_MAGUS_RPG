...
Note: This page is an overview. The canonical, detailed rules live in `COMBAT_MECHANICS.md`. When in doubt, defer to the detailed document.
...
- **Example**: Roll 97, skill 2 → TÉ 157 vs VÉ 110
  ...
  - Critical does NOT route directly to EP — only FP is amplified; EP loss comes from reach rule.
