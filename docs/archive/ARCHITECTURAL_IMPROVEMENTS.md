# Archived: Architectural Improvements - November 2025

This document has been archived. It captured refactoring notes from November 2025. See current architecture in `docs/ARCHITECTURE.md` and current status in `docs/PROJECT_STATUS.md`.
