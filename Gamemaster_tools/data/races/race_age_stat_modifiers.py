...
RACE_MODIFIERS = {
    "Amund": {
        "modifiers": {"Erő": +1, "Állóképesség": +1, "Karizma": +2, "Asztrál": -1},
        "limits": {"Erő": (4, 19), "Állóképesség": (4, 19), "Karizma": (5, 20), "Asztrál": (2, 17)},
        "hard_limits": {
            "Erő": (1, 20),
            "Állóképesség": (1, 20),
            "Karizma": (1, 22),
    ...
    "Dzsenn": {
        "modifiers": {"Intelligencia": +2},
        "limits": {"Intelligencia": (3, 20)},
        "hard_limits": {"Intelligencia": (1, 22)},
    },
    "Ember": {"modifiers": {}, "limits": {}, "hard_limits": {}},
    "Elf": {
        "modifiers": {
            "Erő": -2,
            "Állóképesség": -1,
    ...
    "Félelf": {
        "modifiers": {"Erő": -1, "Gyorsaság": +1},
        "limits": {"Gyorsaság": (4, 19)},
        "hard_limits": {"Gyorsaság": (1, 21)},
    },
    "Khál": {
        "modifiers": {
            "Erő": +3,
    ...
    "Goblin": {
        "modifiers": {"Erő": -2, "Gyorsaság": +2, "Karizma": -3, "Érzékelés": +2},
        "limits": {
            "Erő": (1, 16),
            "Gyorsaság": (5, 20),
            "Ügyesség": (3, 19),
        ...
        "hard_limits": {"Gyorsaság": (1, 22), "Ügyesség": (1, 21), "Érzékelés": (1, 19)},
    },
    # többi faj...
}
