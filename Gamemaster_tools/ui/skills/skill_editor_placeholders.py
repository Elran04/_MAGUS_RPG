...
class PlaceholderEditorTab:
    ...
    def create_resolution_editor_panel(self):
        ...
        self.placeholder_info_label.setStyleSheet("font-weight: bold; font-size: 11pt; margin-bottom: 10px;")
    ...
    def add_resolution(self):
        ...
        if not self.current_placeholder:
            QMessageBox.warning(self.tab_widget, "Nincs kiválasztva", "Válassz ki egy helyfoglalót!")
            return
        ...
        try:
            ...
            QMessageBox.critical(self.tab_widget, "Hiba", f"Nem sikerült hozzáadni a feloldást:\n{e}")
    ...
    def remove_resolution(self):
        ...
        if not current_item:
            QMessageBox.warning(self.tab_widget, "Nincs feloldás kiválasztva", "Válassz ki egy feloldást a törléshez!")
            return
        ...
        if reply == QMessageBox.Yes:
            try:
                ...
                QMessageBox.critical(self.tab_widget, "Hiba", f"Nem sikerült törölni a feloldást:\n{e}")
