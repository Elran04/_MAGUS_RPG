...
class AttributesDisplayWidget(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        self.attribute_manager: AttributeManager | None = None
    ...
    def _roll_attributes(self):
        ...
        if not self.attribute_manager:
            QtWidgets.QMessageBox.warning(
                self, "Hiba", "Először válassz fajt, kasztot és életkort!"
            )
            return
        ...
        self._set_character_data(
            "_AttributeRolledBase", self.attribute_manager.original_class_values.copy()
        )
        self._save_and_emit()
    ...
    def _save_and_emit(self):
        ...
        self._set_character_data(
            "_AttributeClassValues", self.attribute_manager.class_values.copy()
        )
