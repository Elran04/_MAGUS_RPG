...
class WeaponMaterialQualityManager:
    ...
    def __init__(self):
        ...
        self.DEFAULT_MODIFIER: dict[str, int | float] = {
            stat: (1.0 if stat in ["Súly", "STP", "Ár"] else 0.0) for stat in self.MODIFIABLE_STATS
        }
        self.craft_quality_mods: dict[str | tuple, dict[str, int | float]] = {
            ...
            "Törpe kovács": {
                ...
                "Átütőerő": 4.0,
                "STP": 2.5,
                "Ár": 10000.0,  # gyakorlatilag megfizethetetlen
            },
            "Gilron-pap": {
                "KÉ": 5.0,
                "TÉ": 10.0,
                ...
                "Sebzés": 2.0,
                "Átütőerő": 2.0,
                "STP": 250.0,  # mágikus, extrém magas
                "Ár": 300.0,
            },
        }
        self.handforged_mods: dict[bool, dict[str, int | float]] = {}
        self.customize_mods: dict[bool, dict[str, int | float]] = {
            False: self.DEFAULT_MODIFIER.copy(),
            True: {"TÉ": 2.0, "VÉ": 2.0, "Sebzés": 1.0, "Ár": 3.0},
        }
        self.modification_mods: dict[str | tuple, dict[str, int | float]] = {
            "default": self.DEFAULT_MODIFIER.copy(),
            ...
            ("Támadásra", "Átlagos munka"): {"TÉ": 2.0, "VÉ": -4.0, "Sebzés": 1.0, "Ár": 1.5},
            ...
            ("Védelemre", "Kivételes munka"): {"KÉ": -1.0, "TÉ": -1.0, "VÉ": 2.0, "Ár": 5.0},
        ...
        self.material_mods: dict[str, dict[str, int | float]] = {
            "default": self.DEFAULT_MODIFIER.copy(),
            "Bronz": {
                "KÉ": -1.0,
                "TÉ": -3.0,
            ...
            "Kiváló acél": {"TÉ": 1.0, "VÉ": 1.0, "Átütőerő": 1.0, "STP": 1.2, "Ár": 2.0},
            "Abbit (Tiszta)": {"TÉ": -1.0, "VÉ": -1.0, "Átütőerő": -1.0, "STP": 1.2, "Ár": 2.5},
            "Abbit-acél": {
                "KÉ": 1.0,
                "TÉ": 2.0,
                "VÉ": 2.0,
